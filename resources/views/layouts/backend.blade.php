                ...
                <div class="content-side">
                    <ul class="nav-main">
                        ...
                        @if ($userRole == 'Admin' || $userRole == 'Moderator')
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->segment(2) == 'companies' ? ' active' : '' }}"
                        ...
                        @if ($userRole == 'Admin')
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->segment(2) == 'recommendations' ? ' active' : '' }}"
                                    href="{{ route('admin.recommendations.index') }}">
                                    <i class="nav-main-link-icon fa fa-thumbs-up"></i>
                                    <span class="nav-main-link-name">Recommendations</span>
                                </a>
                            </li>

                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->segment(2) == 'moderators' ? ' active' : '' }}"
                                    href="{{ route('admin.moderators.index') }}">
                                    <i class="nav-main-link-icon fa fa-user"></i>
                                    <span class="nav-main-link-name">Moderators</span>
                                </a>
                            </li>
                        @endif
