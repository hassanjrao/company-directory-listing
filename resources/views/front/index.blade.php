                        ...
                        <li>
                            <div class="input-group stylish-input-group">
                                <input type="text" placeholder="What are you looking for?" class="form-control"
                                    name="search" id="form-website" data-error="Search text required" required>
    ...
    <section class="listing-wrap-layout1 padding-top-9p6 padding-bottom-7 bg--light">
        <div class="container">
            <div class="section-heading heading-dark heading-center">
                <h2 class="item-title">Latest Added Companies</h2>
            </div>
            ...
            <div class="row mt-5">
                <div class="col-12">
                    <div class=" text-center">
                        <a href="{{ route("companies.index") }}" class="btn-main">See All Companies</a>
                    </div>
                </div>
            </div>
